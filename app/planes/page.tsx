...
export default function PlanesPage() {
  ...
  const tipos = [...new Set(PLANS.map((i) => i.tipo))];
  const provincias = [...new Set(PLANS.map((i) => i.provincia))];
      ...
      >
        ...
        >
          {filtered.length === 0 ? (
            ...
            >
              <p style={{ fontSize: 16 }}>
                No se encontraron planes para esta busqueda.
              </p>
            </div>
          ) : (
